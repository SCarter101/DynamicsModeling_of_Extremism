"""
Python model 'SFD Model_10.20.2025_unconstrained.py'
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"extremist_actors": 1, "online_recruitment_rate": 1},
)
def engagement():
    return extremist_actors() * online_recruitment_rate()
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"extremist_actors": 1, "law_enforcement": 1, "controlled_isolation": 1},
)
def radicalization():
    return extremist_actors() * (law_enforcement() - controlled_isolation())
...
def escalation():
    return movement_actors() * (controlled_isolation() - deescalation_efforts())
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"tsis": 1, "deescalation_efforts": 1, "personal_isolation": 1},
)
def mobilization():
    return tsis() * (personal_isolation() - deescalation_efforts())
